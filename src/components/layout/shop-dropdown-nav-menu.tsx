    ...
    <>
      ...
      >
        ...
        <Link
          href={"/shop"}
          className={cn(
            "p-2 flex items-center relative text-xl whitespace-nowrap transition-colors duration-300 after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] after:bg-secondary-foreground after:transition-width after:duration-300 hover:after:w-full",
            pathname === link.slug
        ...
        {mainDropdownOpen && (
          <div
            className="absolute -left-2 bg-background rounded-sm shadow-lg z-50 w-fit border border-gray-200"
            style={{ top: "100%", marginTop: "0.2rem" }}
          >
            {isLoading ? (
              <>
              ...
              categories?.map((category) => (
                ...
                >
                  <a
                    ...
                    className={cn(
                      "flex items-center justify-between px-4 py-2 text-sm text-primary hover:text-secondary-foreground whitespace-nowrap transition-colors duration-300",
