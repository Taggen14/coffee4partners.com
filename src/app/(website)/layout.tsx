...
export const metadata: Metadata = {
  title: 'Kaffeautomater & Obemannade Kafélösningar för Företag | Coffee4partners',
  description: 'Professionella kaffeautomater, vatten- och varuautomater för arbetsplatser. Smak- och driftgaranti. Branschvinnare 2024. Kontakta oss för kostnadsfritt möte!',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Professionella kaffeautomater, vatten- och varuautomater för arbetsplatser. Smak- och driftgaranti. Branschvinnare 2024.',
    images: [
      {
        url: '/logo.png',
        width: 120,
  ...
  twitter: {
    ...
    title: 'Kaffeautomater & Obemannade Kafélösningar för Företag',
    description: 'Professionella kaffeautomater för arbetsplatser. Smak- och driftgaranti.',
    images: ['/logo.png'],
  },
  alternates: {
