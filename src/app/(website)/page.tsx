      ...
      <div className="flex flex-wrap gap-4 justify-center">
        {machines.map((machine, i) => (
          <Link
            ...
            className="relative w-full sm:max-w-[300px] h-96 border p-4 flex flex-col justify-end overflow-hidden shadow-sm"
          >
            <CldImage
            ...
            <div className="relative z-10 space-y-2">
              ...
              <Button variant={"secondaryInverted"}>{machine.cta.text}</Button>
            </div>
          </Link>
        ))}
      </div>
          ...
          {shopProductLinks.map((product, i) => (
            <Link key={i} href={product.href}>
              <div key={i} className="relative w-48 h-48 group overflow-hidden">
                ...
                <p className="text-background text-xl relative z-10 flex justify-center items-center h-full">
                  {product.title}
                </p>
              </div>
            </Link>
