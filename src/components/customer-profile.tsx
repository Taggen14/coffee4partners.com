...
export const ProfilDropdown = () => {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent side='bottom' align='end' className={cn("", !isSignedIn ? "hidden" : "block")}>
                {
                    isLoaded && isSignedIn ?
                        <div className='flex flex-col items-end p-2'>
                            ...
                            <p className='px-2'>{capitalizeFirstLetter(user?.emailAddresses[0].emailAddress)}</p>
                            <DropdownMenuSeparator />
